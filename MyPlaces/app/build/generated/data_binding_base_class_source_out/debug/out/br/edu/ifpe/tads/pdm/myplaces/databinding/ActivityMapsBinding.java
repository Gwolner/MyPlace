...
public final class ActivityMapsBinding implements ViewBinding {
  ...
  private ActivityMapsBinding(@NonNull LinearLayout rootView, @NonNull Button buttonLocation) {
  ...
  public static ActivityMapsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Button buttonLocation = rootView.findViewById(id);
      if (buttonLocation == null) {
        break missingId;
      }

      return new ActivityMapsBinding((LinearLayout) rootView, buttonLocation);
    }
